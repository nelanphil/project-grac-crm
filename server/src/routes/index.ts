...
import workOrderTypeRoutes from "./workOrderType.routes";
import noteTemplateRoutes from "./noteTemplate.routes";
...
import emailMessageRoutes from "./emailMessage.routes";
...
import estimateTemplateRoutes from "./estimateTemplate.routes";
...
router.use("/work-order-types", workOrderTypeRoutes);
...
router.use("/estimate-templates", estimateTemplateRoutes);
