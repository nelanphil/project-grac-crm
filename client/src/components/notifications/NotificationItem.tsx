...
export default function NotificationListItem({
  ...
  return (
    <button
      ...
      className={`flex w-full min-w-0 flex-col gap-1 border-b border-neutral-100 px-4 py-3 text-left transition-colors last:border-b-0 hover:bg-neutral-50 ${
        item.read ? "bg-white" : "bg-brand-orange/5"
      }`}
    >
      <div className="flex items-start justify-between gap-3">
        <p
          className={`min-w-0 flex-1 break-words text-sm leading-snug text-brand-dark ${
